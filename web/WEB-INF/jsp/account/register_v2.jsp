                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <strong>2. 개인정보 자동수집 장치의 설치, 운영 및 그 거부에 관한 사항</strong><br>
                                    <strong>가. 회원 인증에 쿠키(Cookie)를 사용하는 것에 대한 안내</strong><br>
                                    회사는 고객님에게 보다 적절하고 유용한 서비스를 제공하기 위하여 고객님이 로그인하는 회원 인증 부분에서 쿠키를 사용합니다. 쿠키란 웹사이트에 접속하면 자동으로 고객님의 웹 브라우저에 생성되는 텍스트 파일을 말합니다. 이 쿠키는 고객님께서 로그아웃(Log-out) 후, 웹 브라우저를 닫으면 자동으로 삭제됩니다.<br><br>

                                    서비스의 일부로써, 그들은 귀하의 장치에 별도의 쿠키를 저장할 수 있습니다.<br><br>

                                    <strong>[쿠키 저장 거부 방법]</strong><br>
                                    웹 브라우저의 설정을 변경하여 쿠키의 저장을 허용하거나 거부할 수 있습니다. 다음은 Internet Explorer에서의 쿠키 설정에 접근하는 절차입니다.<br>
                                    * 웹 브라우저 상단의 [도구] → [인터넷 옵션] → [개인 정보] → [설정]의 [고급] → [쿠키]<br><br>

                                    단, 쿠키의 저장을 거부할 경우에는 서비스의 이용에 제한이 생길 수 있으며, 이에 대한 책임은 전적으로 고객님에게 있음을 유의하시기 바랍니다.<br><br>

                                    <strong>나. Google 애널리틱스에 관한 안내</strong><br>
                                    회사는 고객님에게 더 나은 서비스를 제공하기 위한 목적으로 Google LLC(이하 ‘Google’)가 제공하는 웹 분석 서비스인 Google 애널리틱스를 사용합니다. 이를 통해 고객님이 서비스를 어떻게 이용하는지 분석하고 수요를 파악하여 서비스와 제품을 개선합니다.<br>
                                    Google 애널리틱스는 쿠키를 사용하여 고객님의 웹사이트 이용 방식을 수집합니다.<br>
                                    Google은 쿠키를 통하여 수집한 정보를 미국에 소재한 Google 서버로 전송하여 저장합니다.<br>
                                    Google은 이 정보를 법률에 의해 요구되는 경우 제3자에게 제공하거나 Google을 대신해서 해당 정보를 처리하는 제3자에게 제공할 수 있습니다.<br>
                                    Google은 고객님의 IP 주소를 Google이 보유한 다른 어떠한 데이터와 연관 짓지 않습니다.<br>
                                    고객님은 별도로 쿠키 이용을 거부하지 않는 한, 회사의 서비스 이용 중 생성된 쿠키 및 Google 애널리틱스를 통해 생성된 모든 정보의 이용에 동의하게 됩니다.<br>
                                    Google의 개인정보보호에 관한 내용은 여기에서 확인하실 수 있습니다.<br>
                                    Google 애널리틱스의 데이터 수집을 거부하려면 Google 사이트를에서 설정하거나 위의 [쿠키 설정 거부 방법]을 통해 쿠키의 저장을 거부할 수 있습니다. 단, 쿠키의 저장을 거부할 경우 로그인이 필요한 일부 서비스 이용에 제한이 생길 수 있으며, 이에 대한 책임은 전적으로 고객님에게 있음을 유의하시기 바랍니다.<br><br>

                                    <strong>3. 회원이 등록한 게시물의 이용 및 삭제</strong><br>
