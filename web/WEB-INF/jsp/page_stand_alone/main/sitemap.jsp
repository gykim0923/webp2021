...
<script>
    ...
    function makeSiteMap() { // 사이트맵 화면 만드는 함수
        ...
        // for(var i =0; i<pageTab1.length; i++){ //카드 레이아웃
        //     text += ''
        //     text += '<div class="col-lg-4">'
        //     text +='<div class="card card-margin">'
        //     text += '<div class="card-header no-border"></div>'
        //     text += '<div class="card-body pt-0">'
        //     text += ' <div class="widget-49"> '
        //     text += ' <div class="widget-49-title-wrapper"> '
        //     text += '<div class="widget-49-meeting-info">'
        //     text += '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16"> <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/> </svg><h4 class="card-title">'+pageTab1[i].tab_title+'</h4></div> </div>'
        //     text += '<ol class="widget-49-meeting-points">';
